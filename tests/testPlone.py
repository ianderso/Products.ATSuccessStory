...
#
# Base TestCase for ATSuccessStory
#
...
from Products.ATSuccessStory.config import HAS_PLONE21
from Products.ATSuccessStory.config import PRODUCT_DEPENDENCIES
...
PRODUCT_DEPENDENCIES.append('ATSuccessStory')
...
ZopeTestCase.installProduct('ATSuccessStory')

PRODUCTS = list()
PRODUCTS += DEPENDENCIES
PRODUCTS.append('ATSuccessStory')
