...
from Products.ATSuccessStory.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install ATSuccessStory """
    out = StringIO()
    ...
    factory_types=[
        "ATSuccessStoryFolder",
        "ATSuccessStory",
        ] + factory_tool.getFactoryTypes().keys()
    factory_tool.manage_setPortalFactoryTypes(listOfTypeIds=factory_types)

    from Products.ATSuccessStory.config import STYLESHEETS
    try:
        ...
        pass
    from Products.ATSuccessStory.config import JAVASCRIPTS
    try:
